"""
平均足75SMA手法 M5版（20SMA割れ決済・ADXなし）
エントリー：M5カセットと同じ（色継続もOK・ADXなし）
決済：ha_closeが20SMAをタッチ・割れたら（ロング）/ 上回ったら（ショート）
"""
import pandas as pd

NAME = "平均足75SMA M5（20SMA割れ決済・ADXなし）"
GRANULARITY = "M5"
COUNT = 200
